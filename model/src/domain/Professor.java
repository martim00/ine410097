...
public class Professor {
	 ...
	 * 
	 * @pre Professor deve ter algum horario disponivel =>
	 *      <code>assert(this.temHorarioDisponivel());</code>
	 * @return
	 */
	public Horario aloqueHorario() {
		...
		Horario primeiroHorarioDisponivel = this.getHorariosDisponiveis()
				.get(0);
